        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="{{asset('bower_components/admin_template/images/logo.png')}}"
                            alt="">
                    </a>
                </div>
                    ...
                    <form action="{{route('admin_login')}}" method="POST">
                        ...
                        <div class="col-sm-12">
                            <div class="alert  alert-danger alert-dismissible fade show" role="alert">
                                <span class="badge badge-pill badge-danger">@lang('admin.error')</span> {{$message}}
